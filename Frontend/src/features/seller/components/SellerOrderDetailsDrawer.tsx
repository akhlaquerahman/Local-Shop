...
interface SellerOrderDetailsDrawerProps {
  order: any;
  onClose: () => void;
}
...
export const SellerOrderDetailsDrawer: React.FC<SellerOrderDetailsDrawerProps> = ({ order, onClose }) => {
    ...
    <>
      ...
      <div className="fixed right-0 top-0 bottom-0 w-full md:w-[900px] bg-surface shadow-enterprise-xl z-50 flex flex-col animate-in slide-in-from-right duration-300">
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-border bg-background/50">
          <div>
            <h2 className="text-xl font-black text-text-primary">Order {order.orderId || order._id.substring(0, 8)}</h2>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-background border border-border rounded-2xl p-5">
                <h3 className="font-bold text-text-primary mb-3 flex items-center gap-2">
                  <MapPin size={16} className="text-accent" /> Customer Address
                </h3>
