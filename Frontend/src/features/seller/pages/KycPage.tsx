...
const requiredDocuments = [
  { id: 'GSTIN', label: 'GSTIN Certificate', description: 'Upload your valid GST certificate.' },
  { id: 'PAN_CARD', label: 'PAN Card', description: 'Business PAN card image.' },
  { id: 'AADHAAR', label: 'Aadhaar Card', description: 'Aadhaar card front and back.' },
  { id: 'FSSAI', label: 'FSSAI License', description: 'Required if you sell food items.' },
  { id: 'CANCELLED_CHEQUE', label: 'Cancelled Cheque', description: 'For bank account verification.' },
  { id: 'BANK_PROOF', label: 'Bank Verification', description: 'Bank statement or passbook.' },
  { id: 'TRADE_LICENSE', label: 'Trade License', description: 'Valid trade license for your business.' },
];
    ...
    <div className="space-y-6 text-left max-w-5xl mx-auto pb-20">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-text-secondary">Complete your KYC to unlock all seller features.</p>
        </div>
      </div>
              ...
              <FormProvider {...methods}>
                <form onSubmit={methods.handleSubmit(onSubmit)} className="space-y-4">
                  <div className="space-y-1.5">
                    ...
                    <input type="text" {...methods.register('documentNumber')} className="w-full px-3 py-2 bg-background border border-border rounded-lg text-sm" placeholder="e.g. ABCDE1234F" />
                  </div>

                  <div className="space-y-1.5">
                    <label className="text-sm font-bold text-text-primary">Front Image / PDF</label>
